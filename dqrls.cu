/* /home/fas/gerstein/ll426/scratch/code/logit-fit/dqrls.f -- translated by f2c (version 20160102).
...
/*     reduce x. */
    ...
    /* Function Body */
    dqrdc2_(x, n, n, p, tol, k, qraux, jpvt, work);
...
/*     solve the truncated least squares problem for each rhs. */
	...
	for (jj = 0; jj < i__1; ++jj) {
/* L20: */
	    dqrsl_(&x[x_dim1-1], n, n, k, &qraux[0], &y[(jj+1) * y_dim1], &
